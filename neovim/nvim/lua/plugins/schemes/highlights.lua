...
M.highlights = function(scheme)
	...
	vim.api.nvim_set_hl(0, "GitSignsAdd", { fg = green[1] })
	...
	vim.api.nvim_set_hl(0, "GitSignsStagedUntracked", { fg = magenta[3] })
